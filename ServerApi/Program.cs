    ...
    private static async Task Main(string[] args)
    {
        ...
        builder.Services.AddOpenIddict()
            ...
            .AddClient(opt =>
            {
                ...
                .AddGoogle(o =>
                {
                    o.SetClientId(builder.Configuration["Authentication:Google:ClientId"]!)
                ...
                .AddLinkedIn(o =>
                {
                    o.SetClientId(builder.Configuration["Authentication:LinkedIn:ClientId"]!)
                    .SetClientSecret(builder.Configuration["Authentication:LinkedIn:ClientSecret"]!)
                    .SetRedirectUri("callback/login/linkedin")
                    .AddScopes("email");
                });
            })
            .AddValidation(opt =>
